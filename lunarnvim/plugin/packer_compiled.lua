...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/maxjkfc/.local/share/lunarvim/site/pack/packer/opt/git-blame.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'lightspeed.nvim', 'Comment.nvim', 'telescope-fzy-native.nvim', 'git-blame.nvim', 'nvim-bqf', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
